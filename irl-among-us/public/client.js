...
socket.on('gameStarted', (data) => {
    ...
    let roleColor = '#ff453a'; // imposter red
    if (myRole === 'crewmate') roleColor = '#0a84ff'; // blue
    else if (myRole === 'doctor') roleColor = '#30d158'; // green
    else if (myRole === 'sheriff') roleColor = '#ffd60a'; // dark yellow
    else if (myRole === 'jailor') roleColor = '#8e8e93'; // grey
    else if (myRole === 'jester') roleColor = '#a855f7'; // purple
